...
def main():
    ...
    summary_template = """
    Given the information {information} about a person, summarize it in a few sentences.
    1. Short Summary
    ...
    # llm = ChatOllama(tempurature=0, model="gemma3:270m")

    chain = summary_promt_template | llm 
    response = chain.invoke(input={information})
